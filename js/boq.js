(function initializeBoqEditor() {
  ...
  function categorySubtotalRow(category) {
    ...
    return `<tr class="category-subtotal-row" data-category-subtotal="${escapeHtml(category)}"><td class="editor-sticky-column editor-sticky-index"></td><td></td><td class="editor-sticky-column editor-sticky-item category-subtotal-label">${escapeHtml(category)} subtotal</td><td></td><td class="editor-sticky-column editor-sticky-qty"></td><td class="editor-sticky-column editor-sticky-unit"></td><td class="column-cogs column-price"></td><td class="align-right column-cogs column-price" data-category-total="cogs">${formatCurrencyMarkup(summary.totalCogs, currentCurrency())}</td><td class="column-margin column-price"></td><td class="column-selling column-price"></td><td class="align-right column-selling column-price" data-category-total="selling">${formatCurrencyMarkup(summary.totalSelling, currentCurrency())}</td><td></td></tr>`;
  }
